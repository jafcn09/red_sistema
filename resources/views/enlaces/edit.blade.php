...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('enlaces.update', $enlace) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')

            <div class="card ">
              <div class="card-header card-header-warning">
                <h4 class="card-title">{{ __('Editar Enlace') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <select title="" name="user_id" id="user_id" class="form-control form-control-xs selectpicker" data-live-search="true">
                            <option value="{{$enlace->user_id}}">{{$enlace->user->nombres}} {{$enlace->user->apellidos}} - {{$enlace->user->cedula}}</option>
              ...
              <div class="row">
                  ...
                  <div class="col-sm-3">
                    ...
                    <select title="" name="router_id" id="router_id" class="form-control form-control-xs selectpicker" style="text-decoration: none;color:white; background-color: white;" data-live-search="true">
                            <option value="{{$router->id}}" selected>{{$router->marca}} {{$router -> modelo}} {{$router -> codigo}}</option>
                        @foreach($equipos as $equipo)
                            <option value="{{$equipo -> id}}">
                            {{$equipo -> marca}} {{$equipo -> modelo}} {{$equipo -> mac}}</option>
                        @endforeach
                    </select>  
                  ...
                  <div class="col-sm-3">
                    ...
                    <select title="" name="nodo_id" id="nodo_id" class="form-control form-control-xs selectpicker" data-live-search="true">
                            <option value="{{$enlace->nodo_id}}">{{$enlace->nodo->nombre}} {{$enlace->nodo->ip}}</option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <select title="" name="producto_id" id="producto_id" class="form-control form-control-xs selectpicker" style="text-decoration: none;color:white; background-color: white;" data-live-search="true">
                            <option value="{{$enlace->producto_id}}" selected>{{$enlace->producto->marca}} {{$enlace->producto->modelo}} {{$enlace->producto->codigo}}</option>
                            @foreach($equipos as $equipo)
                                <option value="{{$equipo -> id}}">
                                {{$equipo -> marca}} {{$equipo -> modelo}} {{$equipo -> codigo}}</option>
                            @endforeach
                    </select>  
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('ip') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('ip') ? ' is-invalid' : '' }}" name="ip" id="input-ip" type="text" placeholder="{{ __('Ingrese su ip') }}" value="{{ old('ip', $enlace->ip) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('mac') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('mac') ? ' is-invalid' : '' }}" name="mac" id="input-mac" type="text" placeholder="{{ __('Ingrese la mac') }}" value="{{ old('mac', $enlace->mac) }}" required="true" />
                      @if ($errors->has('mac'))
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('coordenadas') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('coordenadas') ? ' is-invalid' : '' }}" name="coordenadas" id="input-coordenadas" type="text" placeholder="{{ __('Ingrese coordenadas') }}" value="{{ old('coordenadas', $enlace->coordenadas) }}"  />
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="selectpicker" name="activo" data-style="select-with-transition" data-size="4">
                        @if($enlace->activo == "SI")
                           <option selected value="SI">ACTIVO
                        @elseif($enlace->activo == "NO")
                           <option selected value="NO">INACTIVO
                        @endif
                           </option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group{{ $errors->has('imagen') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('imagen') ? ' is-invalid' : '' }}" name="imagen" id="input-imagen" type="text" placeholder="{{ __('Ingrese la imagen del enlace') }}" value="{{ old('imagen', $enlace->imagen) }}" />
