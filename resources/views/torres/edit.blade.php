...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('torres.update', $torre) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')

            <div class="card ">
              <div class="card-header card-header-warning">
                <h4 class="card-title">{{ __('Editar Torre') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input onkeyup="mayus(this);" class="form-control{{ $errors->has('nombre_torre') ? ' is-invalid' : '' }}" name="nombre_torre" id="input-nombre_torre" type="text" placeholder="{{ __('Ingrese el nombre de la torre') }}" value="{{ old('nombre_torre', $torre->nombre_torre) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group{{ $errors->has('descripcion_torre') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('descripcion_torre') ? ' is-invalid' : '' }}" name="descripcion_torre" id="input-descripcion_torre" type="text" placeholder="{{ __('Ingrese su descripcion de la torre') }}" value="{{ old('descripcion_torre', $torre->descripcion_torre) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('calle_p') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('calle_p') ? ' is-invalid' : '' }}" name="calle_p" id="input-calle_p" type="text" placeholder="{{ __('Ingrese la calle principal') }}" value="{{ old('calle_p', $torre->calle_p) }}" required="true" />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('calle_s') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('calle_s') ? ' is-invalid' : '' }}" name="calle_s" id="input-calle_s" type="text" placeholder="{{ __('Ingrese la calle secundaria') }}" value="{{ old('calle_s', $torre->calle_s) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-8">
                    ...
                    <input onkeyup="mayus(this);" class="form-control{{ $errors->has('direccion') ? ' is-invalid' : '' }}" name="direccion" id="input-direccion" type="text" placeholder="{{ __('Ingrese la direccion de la torre') }}" value="{{ old('direccion', $torre->direccion) }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input onkeyup="mayus(this);" class="form-control{{ $errors->has('coordenadas') ? ' is-invalid' : '' }}" name="coordenadas" id="input-coordenadas" type="text" placeholder="{{ __('Ingrese las coordenadas de la torre') }}" value="{{ old('coordenadas', $torre->coordenadas) }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="selectpicker" name="activo" data-style="select-with-transition" data-size="4">
                          <option value="{{$torre->activo}}">{{$torre->activo}}</option>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('imagen') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('imagen') ? ' is-invalid' : '' }}" name="imagen" id="input-imagen" type="text" placeholder="{{ __('Ingrese la imagen del torre') }}" value="{{ old('imagen', $torre->imagen) }}" />
