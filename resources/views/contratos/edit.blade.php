...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('contratos.update', $contrato) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')

            <div class="card ">
              <div class="card-header card-header-warning">
                <h4 class="card-title">{{ __('Editar Contrato') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">                
                  ...
                  <div class="col-sm-8">
                    ...
                    <option value="{{$contrato->user_id}}">{{$contrato->user->nombres}} {{$contrato->user->apellidos}} {{$contrato->user->cedula }}</option>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input class="form-control{{ $errors->has('contrato_num') ? ' is-invalid' : '' }}" name="contrato_num" id="input-contrato_num" type="text" placeholder="{{ __('Ingrese su contrato_num') }}" value="{{ old('contrato_num', $contrato->contrato_num) }}" disabled="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('fecha_inicio') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('fecha_inicio') ? ' is-invalid' : '' }}" name="fecha_inicio" id="input-fecha_inicio" type="date" placeholder="{{ __('Ingrese su fecha_inicio') }}" value="{{ old('fecha_inicio', $contrato->fecha_inicio) }}" required />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('fecha_fin') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('fecha_fin') ? ' is-invalid' : '' }}" name="fecha_fin" id="input-fecha_fin" type="date" placeholder="{{ __('Ingrese su fecha_fin') }}" value="{{ old('fecha_fin', $contrato->fecha_fin) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group{{ $errors->has('descripcion') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" id="input-descripcion" type="text" placeholder="{{ __('Ingrese la descripcion del contrato') }}" value="{{ old('descripcion', $contrato->descripcion) }}" required />
                    ...
                    <div class="form-group{{ $errors->has('plan_id') ? ' has-danger' : '' }}">
                        <select class="form-control" name="plan_id" class="custom-select"> 
                            ...
                            @foreach($planes as $plan)
                              ...
                              <option selected value="{{ $plan->id }}">{{ $plan->id }} {{ $plan->nombre }} {{ $plan->capacidad }} M {{ $plan->precio }}
                              @endif
                            @endforeach
                          </option>
                            @foreach($planes as $plan)
