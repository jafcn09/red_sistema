        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="card card-stats">
            <div class="card-header card-header-danger card-header-icon">
              ...
              <h3 class="card-title">{{$productos + $productos1}}</h3>
            </div>
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons">date_range</i> Ultimas 24 Horas
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card card-chart">
            ...
            <div class="card-body">
              <h4 class="card-title">Total Facturas Pagadas: <strong class="text-danger">{{$fact}}</strong></h4>
              ...
              <div class="stats">
                ...
                @if($fact > 0)
                    @if($fecha_fact == null)
                      Sin información
                    @else
                    {{ \Carbon\Carbon::parse($fecha_fact->updated_at)->format('d/m/Y H:i:s') }}</p>
                    @endif
                @else
                    Sin información
                @endif
        ...
        <div class="col-md-4">
          <div class="card card-chart">
            ...
            <div class="card-body">
              <h4 class="card-title">Total Servicios Completados: <strong class="text-danger">{{$task1}}</strong></h4>
              <p class="card-category">La última actualización fue</p>
            </div>
            <div class="card-footer">
              <div class="stats">
                ...
                @if($task1 > 0)
                    @if($fecha_tas1 == null)
                      Sin información
                    @else
                    {{ \Carbon\Carbon::parse($fecha_tas1->updated_at)->format('d/m/Y H:i:s') }}</p>
                    @endif
                @else
                    Sin información
                @endif
                ...
                <div class="modal-body">
                    ...
                    @endif
                                    ...
                                    <strong class="input-group-addon text-info">
                                      ...
                                      {{ \Carbon\Carbon::parse($tarea->fecha_solucion)->format('d/m/Y') }}
                                    </div>
                                    <div class="">
                                    <strong class="input-group-addon text-info">
                                        TÉCNICO RESPONSABLE:
                                    ...
                                    @foreach($empleados as $empleado)
                                       @if($empleado->id == $tarea->asignado_a)
                          ...
                          <div class="modal-footer justify-content-center">
                              <button type="submit" class="btn btn-danger">Guardar Cambios</button>
                                    ...
                                    @elseif(auth()->user()->isRole('CLIENTE'))
                                      <textarea readonly="true" onkeyup="mayus(this);" name="solucion" placeholder="Ingrese la solución" class="form-control">{{ $tarea->solucion }}</textarea>
                            ...
                            <div class="form-group bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <select disabled class="form-control" name="estatus" data-style="select-with-transition" data-size="2"> 
                                            @if($tarea->estatus == "ASIGNADA")
                                        <option selected value="ASIGNADA">ASIGNADA
                                            @elseif($tarea->estatus == "EN-PROCESO")
                                        <option selected value="EN-PROCESO">EN-PROCESO
