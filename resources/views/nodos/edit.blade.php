...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('nodos.update', $nodo) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')

            <div class="card ">
              <div class="card-header card-header-warning">
                <h4 class="card-title">{{ __('Editar Nodo') }}</h4>
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input onkeyup="mayus(this);" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" id="input-nombre" type="text" placeholder="{{ __('Ingrese su nombre') }}" value="{{ old('nombre', $nodo->nombre) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input onkeyup="mayus(this);" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" id="input-descripcion" type="text" placeholder="{{ __('Ingrese su descripción del nodo') }}" value="{{ old('descripcion', $nodo->descripcion) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="selectpicker" name="torre_id" data-style="select-with-transition" data-size="10">> 
                        @foreach($torres as $torre)
                          @if($nodo->torre_id == $torre->id)
                              <option selected value="{{$torre->id}}">{{$torre->nombre_torre}} {{$torre->descripcion_torre}}
                          @endif
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="selectpicker" name="producto_id" data-style="select-with-transition" data-size="6">> 
                        @foreach($productos as $producto)
                          @if($nodo->producto_id == $producto->id)
                              <option selected value="{{$producto->id}}">{{$producto->marca}} {{$producto->modelo}}
                          @endif
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('ip') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('ip') ? ' is-invalid' : '' }}" name="ip" id="input-ip" type="text" placeholder="{{ __('Ingrese la IP del dispositivo') }}" value="{{ old('ip', $nodo->ip) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('mac') ? ' has-danger' : '' }}">
                      <input onkeyup="mayus(this);" class="form-control{{ $errors->has('mac') ? ' is-invalid' : '' }}" name="mac" id="input-mac" type="text" placeholder="{{ __('Ingrese la MAC del dispositivo') }}" value="{{ old('mac', $nodo->mac) }}" required="true" />
                      @if ($errors->has('mac'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('imagen') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('imagen') ? ' is-invalid' : '' }}" name="imagen" id="input-imagen" type="text" placeholder="{{ __('Ingrese la imagen del nodo') }}" value="{{ old('imagen', $nodo->imagen) }}" required />
