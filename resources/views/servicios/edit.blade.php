...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('servicios.update', $servicio->id) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
              ...
              <div class="card-body ">
                ...
                <div class="row">     
                  ...
                  <div class="col-sm-8">
                    ...
                    <option selected value="{{ $servicio->categoria['id'] }}"> {{ $servicio->categoria['nombre'] }}</option>                  
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('codigo') ? ' has-danger' : '' }}">
                      <input value="{{ old('codigo', $servicio->codigo) }}" class="form-control{{ $errors->has('codigo') ? ' is-invalid' : '' }}" name="codigo" id="input-codigo" type="text" placeholder="{{ __('Ingrese su codigo') }}" disabled="true" />
                  ...
                  <div class="col-sm-8">
                    <div class="form-group{{ $errors->has('nombre') ? ' has-danger' : '' }}">
                      <input value="{{ old('nombre', $servicio->nombre) }}" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" id="input-nombre" type="text" placeholder="{{ __('Ingrese nombre') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group{{ $errors->has('descripcion') ? ' has-danger' : '' }}">
                      <input value="{{ old('descripcion', $servicio->descripcion) }}" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" id="input-descripcion" type="text" placeholder="{{ __('Ingrese la descripcion del servicio') }}" required />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group{{ $errors->has('precio') ? ' has-danger' : '' }}">
                        <input value="{{ old('precio', $servicio->precio) }}" class="form-control{{ $errors->has('precio') ? ' is-invalid' : '' }}" name="precio" id="input-precio" type="decimal" placeholder="{{ __('Ingrese el precio') }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-3">
                    ...
                    <input value="0" class="form-control{{ $errors->has('cantidad') ? ' is-invalid' : '' }}" name="cantidad" id="input-cantidad" type="hidden"  required />
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Foto del servicio') }}</label>
                    <div class="col-sm-8" class="row h-1">
                      ...
                      @else
                          <img src="{{ asset('uploads/servicios/' . 'img-50x50.png') }}" alt="{{ $servicio->nombre }}">
                      @endif
